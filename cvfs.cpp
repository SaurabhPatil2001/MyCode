...
void man(char*name)
{
    ...
    {
        printf("Description : Used to display list of all file\n");
        printf("Usage : ls\n");
    }
...
void DisplayHelp()
{
    ...
    printf("truncate: To Remove all data files\n");
...
int ReadFile(int fd,char*arr,int isize)
{
    ...
    //  strncpy(where to copy,   source of data,     how much data to copy);
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            //return value of strcmp is 0 if two string ar equals
        ...
        else if(count == 3)
        {
           // cout<<"hello";
            ...
            else if(strcmp(command[0],"open")==0)
            {
                ...
                if(ret>=0)    printf("File is successfully opened with file descripter :%d\n",ret);
            ...
            else if(strcmp(command[0],"read")==0)
            {
                ...
                if(ret ==-1)   printf("ERROR :File not existing\n");
                 if(ret ==-2)   printf("ERROR :Permission Denied\n");
                  if(ret ==-3)   printf("ERROR :Reached at end file\n");
                   if(ret ==-4)   printf("ERROR :It is not regular file\n");
                    if(ret ==0)   printf("ERROR :File is empty\n");
        ...
        else if (count == 4)
        {
            if(strcmp(command[0],"lseek")==0)
            {
                ...
                if(fd == -1)
                {
                    printf("ERROR : Incoorrct parameter\n");
                    continue;
                }
